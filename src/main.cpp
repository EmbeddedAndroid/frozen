...
// Copyright (c) 2017-2018 The Frozen developers
...
#if defined(NDEBUG)
#error "Frozen cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 5 * COIN;
    } else if (nHeight <= 14400 && nHeight >= 1441) {
        nSubsidy = 100 * COIN;
    } else if (nHeight <= 43200 && nHeight >= 14401) {
        nSubsidy = 80 * COIN;
    } else if (nHeight <= 129600 && nHeight >= 43201) {
        nSubsidy = 60 * COIN;
    } else if (nHeight <= 388800 && nHeight >= 129601) {
        nSubsidy = 40 * COIN;
    } else if (nHeight <= 777600 && nHeight >= 388801) {
        nSubsidy = 20 * COIN;
